...
export default function Navbar() {
 ...
 return (
 <header className="sticky top-0 z-50 glass-card border-b border-ink-800">
 <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
 <Link href="/" className="flex items-center gap-2 font-bold text-xl tracking-tight">
 <div className="w-9 h-9 bg-ember-600 flex items-center justify-center text-white shadow-ember-500/20">
 ...
 <Link
 href="/apply"
 className="px-4 py-2 text-sm font-semibold bg-ember-600 hover:bg-ember-500 text-white shadow-ember-600/25 transition"
 >
 Apply Now
 </Link>
 </div>
