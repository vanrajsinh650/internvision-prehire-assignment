    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 glass-card p-6 rounded-2xl border border-slate-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">InternVision Tech Pre-Hire Platform Management</p>
          </div>
        </div>

        <button
          onClick={handleLogout}
          className="px-4 py-2 rounded-xl text-xs font-semibold bg-red-500/10 text-red-400 border border-red-500/30 hover:bg-red-500/20 flex items-center gap-1.5 transition"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="glass-card p-6 rounded-2xl border border-slate-800 space-y-2">
          ...
          <div className="text-[11px] text-blue-400 font-medium">Internship Applications</div>
        </div>
        ...
        <div className="glass-card p-6 rounded-2xl border border-slate-800 space-y-2">
          ...
          <div className="text-[11px] text-slate-400 font-medium">Completed Transactions</div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 border-b border-slate-800 pb-2">
        <button
          ...
          className={`px-4 py-2 rounded-xl text-xs font-semibold transition ${
            activeTab === "overview" ? "bg-blue-600 text-white" : "text-slate-400 hover:text-white hover:bg-slate-900"
          }`}
        >
          Overview
        </button>
        <button
          ...
          className={`px-4 py-2 rounded-xl text-xs font-semibold transition ${
            activeTab === "applications" ? "bg-blue-600 text-white" : "text-slate-400 hover:text-white hover:bg-slate-900"
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 rounded-xl text-xs font-semibold transition ${
            activeTab === "payments" ? "bg-blue-600 text-white" : "text-slate-400 hover:text-white hover:bg-slate-900"
          }`}
        >
        ...
        <div className="glass-card p-6 rounded-2xl border border-slate-800 space-y-6">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-xs text-slate-400">Manage student applications and duration preferences</p>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
              <div className="relative w-full sm:w-64">
                ...
                <input
                  ...
                  className="w-full bg-slate-900 border border-slate-700/80 rounded-xl pl-9 pr-3 py-1.5 text-xs text-white focus:outline-none focus:border-blue-500"
                />
              </div>
              ...
              <select
                ...
                className="bg-slate-900 border border-slate-700/80 rounded-xl px-3 py-1.5 text-xs text-slate-200 focus:outline-none"
              >
              ...
              <button
                ...
                className="px-3.5 py-1.5 rounded-xl text-xs font-semibold bg-emerald-600 hover:bg-emerald-500 text-white flex items-center gap-1.5 transition shadow-md shadow-emerald-600/20"
              >
        ...
        <div className="glass-card p-6 rounded-2xl border border-slate-800 space-y-6">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-xs text-slate-400">Transaction logs, payment status, and OpenPyXL exports</p>
            </div>
