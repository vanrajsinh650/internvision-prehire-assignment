          ...
          <div className="glass-card p-6 rounded-2xl space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">support@internvision.tech</p>
              </div>
            </div>
          </div>
          ...
          <div className="glass-card p-6 rounded-2xl space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">+91 (800) 123-4567</p>
              </div>
            </div>
          </div>
          ...
          <div className="glass-card p-6 rounded-2xl space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">Tech Hub, Bandra Kurla Complex, Mumbai, India</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 glass-card p-8 rounded-3xl border border-slate-800">
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full py-3.5 rounded-xl font-bold bg-blue-600 hover:bg-blue-500 text-white shadow-lg shadow-blue-600/30 flex items-center justify-center gap-2 transition"
              >
