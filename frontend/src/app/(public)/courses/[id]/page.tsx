...
export default function CourseDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!course) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-20 text-center space-y-4">
        ...
        <p className="text-slate-400 text-sm">The course you are looking for does not exist or has been removed.</p>
        <Link href="/courses" className="inline-flex items-center gap-2 text-blue-400 font-semibold text-sm">
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
      <Link href="/courses" className="inline-flex items-center gap-2 text-xs font-semibold text-slate-400 hover:text-white transition">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="glass-card p-6 rounded-2xl space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              {course.technologies.map((tech) => (
                <span key={tech} className="px-3 py-1.5 rounded-lg text-xs font-semibold bg-slate-900 text-blue-300 border border-slate-700">
                  {tech}
                </span>
              ))}
            </div>
        ...
        <div className="space-y-6">
          <div className="glass-card p-6 rounded-2xl space-y-6 sticky top-24 border border-blue-500/30">
            <div>
              <div className="text-xs text-slate-400 font-medium">Total Registration Fee</div>
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl font-bold bg-blue-600 hover:bg-blue-500 text-white shadow-xl shadow-blue-600/30 flex items-center justify-center gap-2 transition"
            >
            ...
            <form onSubmit={handleCreateOrder} className="space-y-4 text-sm">
              ...
              <div className="pt-4 flex items-center justify-between border-t border-slate-800">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="px-6 py-2.5 rounded-xl font-bold bg-blue-600 hover:bg-blue-500 text-white shadow-lg shadow-blue-600/30 flex items-center gap-2 transition disabled:opacity-50"
                >
                  {submitting ? (
                    <>
